package com.example.remusic.ui.components.atoms

// Source - https://stackoverflow.com/questions/68600128/remove-default-padding-on-jetpack-compose-textfield
// Posted by lisonge
            ...
            decorationBox =
                @Composable { innerTextField ->
                    OutlinedTextFieldDefaults.DecorationBox(
                        ...
                        // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                        contentPadding = OutlinedTextFieldDefaults.contentPadding(4.dp, 0.dp, 0.dp, 0.dp)
                    )
                }
        )
    }
